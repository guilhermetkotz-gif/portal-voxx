...
import { X, Send, Paperclip, Mic, Image, FileText, Video, Loader2, Download, Play, Pause, Smile, SmilePlus, Sticker, Trash2, Sun, Moon, Check, CheckCheck, Reply, Star, Pin, Forward, Copy, CornerDownLeft, RefreshCw, AlertCircle, ChevronDown, Sparkles, AlertTriangle } from 'lucide-react';
...
export default function ChatDrawer({ chatId, chatName, clienteId, clienteNome, isGroup, user, onClose }) {
  ...
  // ── Copilot ──────────────────────────────────────────────
  const selectedChat = { id: chatId, name: chatName, isGroup, clienteId: clienteId || '', clienteNome: clienteNome || '' };
