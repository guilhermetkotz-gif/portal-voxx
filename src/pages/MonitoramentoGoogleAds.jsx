...
export default function MonitoramentoGoogleAds() {
      ...
      const contasClientes = clientes
        ...
        .map(c => {
          ...
          return {
            ...
            unidade_nome: c.nome,
            cliente_nome: c.nome,
            // Prioridade: GoogleAdsAccount.responsavel_voxx > Cliente.responsavel_google_ads > outros
            responsavel_voxx: googleAdsData?.responsavel_voxx || c.responsavel_google_ads || c.responsavel_voxx_trafego || c.responsavel_voxx,
  ...
  const handleAssignResponsavel = async (accountId, accountName, userId) => {
    try {
      ...
      // Recarregar dados
      await Promise.all([refetchClientes(), refetchAccounts()]);
