    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 -m-4 lg:-m-8 p-4 lg:p-8">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="bg-slate-900 border border-slate-800 mb-6">
          ...
          <TabsTrigger value="operadores" className="data-[state=active]:bg-emerald-600 data-[state=active]:text-white text-slate-400">
            Operadores VOXX
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="mensagens">
          <AbaMensagensRadar mensagens={mensagens} clientes={clientes} loading={loadingMsgs} gruposEnriquecidos={gruposEnriquecidos} tagGrupoIds={tagGrupoIds} usuarioIdAtual={user?.id} />
        </TabsContent>
